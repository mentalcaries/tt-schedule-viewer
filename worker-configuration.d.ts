/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.types.jsonc` (hash: 1ff58b2b42879ba0fdc6784893e4819e)
// Runtime types generated with workerd@1.20260918.1 2026-09-21 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	CALENDLY_TOKEN: string;
	CALENDLY_ORGANIZATION_URI: string;
	CALENDLY_GROUP_URI: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CALENDLY_TOKEN" | "CALENDLY_ORGANIZATION_URI" | "CALENDLY_GROUP_URI" | "DISPLAY_TIMEZONE">> {}
}
